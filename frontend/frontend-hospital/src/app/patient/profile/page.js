    ...
    return (
      <div className="min-h-screen flex justify-center items-center bg-gray-100">
        <div className="bg-white shadow-xl rounded-3xl p-10 text-center">
          <FaUser className="text-6xl text-cyan-600 mx-auto" />
          ...
          <p className="text-gray-500 my-5">
            Create your patient profile first.
          </p>

          <Link
            href="/patient/profile/create"
            className="bg-cyan-600 text-white px-6 py-3 rounded-xl flex items-center justify-center gap-2"
          >
            <FaPlus />
            Create Profile
          </Link>
          ...
          <div className="flex justify-between items-center">
            ...
            <div className="flex gap-3">
              <Link
                ...
                className="bg-white text-blue-600 px-5 py-3 rounded-xl flex items-center gap-2"
              >
                <FaEdit />
                Edit
              </Link>
              ...
              <button
                ...
                className="bg-red-600 px-5 py-3 rounded-xl flex items-center gap-2"
              >
                <FaTrash />
                Delete
              </button>
